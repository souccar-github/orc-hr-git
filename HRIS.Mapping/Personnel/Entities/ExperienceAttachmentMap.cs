...
{
    public class ExperienceAttachmentMap : ClassMap<HRIS.Domain.Personnel.Entities.ExperienceAttachment>
    {
        public ExperienceAttachmentMap()
        {
            #region Default
            DynamicUpdate();
            DynamicInsert();
