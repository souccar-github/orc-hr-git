...
{
    public class ConvictionAttachmentMap : ClassMap<HRIS.Domain.Personnel.Entities.ConvictionAttachment>
    {
        public ConvictionAttachmentMap()
        {
            #region Default
            DynamicUpdate();
            DynamicInsert();
