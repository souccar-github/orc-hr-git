...
namespace HRIS.Validation.MessageKeys
{
    public static class CustomMessageKeysPayrollSystemModule
    {
        ...
        public const string ChooseIsForMonthlyCardsOrIsForEmployeeHasTheSameDeduction = "ChooseIsForMonthlyCardsOrIsForEmployeeHasTheSameDeduction";

        public const string YouMustCheckOneOfSalaryFiledsAsPackageSalary = "YouMustCheckOneOfSalaryFiledsAsPackageSalary";
        ...
        public const string ChooseIsForMonthlyCardsOrIsForEmployeeHasTheSameBenefit = "ChooseIsForMonthlyCardsOrIsForEmployeeHasTheSameBenefit"; // لايمكن استخدام تعويض واعطاءه للموظف في حال كان هذا التعويض هو تعويض اب لتعويضات اخرى
        ...
        public const string ThereIsMonthIntersectWithAnotherMonth = "ThereIsMonthIntersectWithAnotherMonth";
