...
using HRIS.Domain.HealthInsurance.Indexes;
...
namespace HRIS.Domain.Personnel.Entities
{
    public class JobRelatedInfoBase: Entity, IAggregateRoot
    {
        ...
        public virtual ReleasedBy IssuedBy { get; set; }
        [UserInterfaceParameter(Order = 155, IsHidden = true)]
        public virtual string NameForDropdown { get { return ApplicationNumber.ToString(); } }
    }
}
